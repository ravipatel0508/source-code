  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        SvgPicture.asset('assets/neopop_assets/svg/heading_advanced.svg'),
        const Expanded(flex: 5, child: SizedBox()),
        SvgPicture.asset('assets/neopop_assets/svg/text_adjacent_buttons.svg'),
        const SizedBox(height: 20),
        const _AdjacentButtons(),
        const Expanded(flex: 2, child: SizedBox()),
        SvgPicture.asset('assets/neopop_assets/svg/text_config_buttons.svg'),
        const SizedBox(height: 20),
    ...
    return Expanded(
      child: NeoPopButton(
        ...
        child: Padding(
          ...
          child:
              SvgPicture.asset('assets/neopop_assets/svg/cta_text_button.svg'),
        ),
      ),
    );
  }
      ...
      child: NeoPopButton(
        ...
        child: Padding(
          ...
          child: SvgPicture.asset(
            'assets/neopop_assets/svg/cta_text_button.svg',
            color: kPrimaryButtonColor,
          ),
        ),
      ),
  ...
  Widget build(BuildContext context) {
    return NeoPopButton(
      ...
      child: Padding(
        ...
        child: SvgPicture.asset('assets/neopop_assets/svg/cta_text_button.svg'),
      ),
    );
  }
}
