//      !!! [This code is taken from the official NeoPop package example.] !!!

// Import the following packages and add the assets folder to the pubspec.yaml file
//  dependencies:
//   neopop: ^1.0.2
//   flutter_svg: ^1.1.0
...
class PopHomeScreen extends StatelessWidget {
  ...
  Widget _ctaWidget(BuildContext context) => Padding(
        ...
        child: Column(
          children: [
            _HomeScreenCta(
              childPath: 'assets/neopop_assets/svg/cta_text_main_btn.svg',
            ...
            _HomeScreenCta(
              childPath: 'assets/neopop_assets/svg/cta_text_primary_btn.svg',
              onTap: () => Navigator.of(context).push(MaterialPageRoute(
            ...
            const SizedBox(height: 15),
            _HomeScreenCta(
              childPath: 'assets/neopop_assets/svg/cta_text_secondary_btn.svg',
              onTap: () => Navigator.of(context).push(MaterialPageRoute(
            ...
            const SizedBox(height: 15),
            _HomeScreenCta(
              childPath: 'assets/neopop_assets/svg/cta_text_advanced.svg',
              onTap: () => Navigator.of(context).push(MaterialPageRoute(
    ...
    return PopScreenWrapper(
      child: Column(
        children: [
          ...
          SvgPicture.asset('assets/neopop_assets/svg/logo.svg', height: 45),
          const Expanded(flex: 4, child: SizedBox()),
          SvgPicture.asset(
              'assets/neopop_assets/svg/neopop_framework_text.svg'),
