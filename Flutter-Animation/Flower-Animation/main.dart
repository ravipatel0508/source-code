...
// Flower Animation
//
// Created by Martino Yovo (https://twitter.com/martinoyovo)
//
...
class _FlowerAnimationState extends State<FlowerAnimation>
  ...
  void initState() {
    ...
    //     CurvedAnimation(parent: animationController!, curve: Curves.ease));
    color1Animation = ColorTween(begin: color7, end: color8).animate(
        CurvedAnimation(parent: animationController!, curve: Curves.ease));

    // color2Animation = ColorTween(begin: color2, end: color4).animate(
    //     CurvedAnimation(parent: animationController!, curve: Curves.ease));
    color2Animation = ColorTween(begin: color5, end: color6).animate(
        CurvedAnimation(parent: animationController!, curve: Curves.ease));
...
class Petal extends StatelessWidget {
  ...
  final Color? color1;
  final Color? color2;
  const Petal({Key? key, required this.angle, this.color1, this.color2})
      : super(key: key);
...
const color5 = Color(0xFFD55535);
const color6 = Color(0xFFB22656);

const color7 = Color(0xFF5E1A9D);
const color8 = Color(0xFF2C6878);
